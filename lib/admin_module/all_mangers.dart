...
class Allmangers extends StatefulWidget {
  const Allmangers({super.key});

  @override
  State<Allmangers> createState() => _AllmangersState();
}

class _AllmangersState extends State<Allmangers> {
